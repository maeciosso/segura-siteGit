...
function verificar2(){
    ...
    if(email !== "" && senha2 == ""){breadCrumb2(); setTimeout(() => {document.getElementById("bread2").classList.toggle("hide")}, 2000);} ;
    if(email === "" && senha2 !== ""){breadCrumb3(); setTimeout(() => {document.getElementById("bread3").classList.toggle("hide")}, 2000);} ;
    if(email !== "" && senha2 !== ""){breadCrumb5(); setTimeout(() => {document.getElementById("bread5").classList.toggle("hide")}, 2000);; console.log("e-mail:" + email, "senha:" + senha2); document.getElementById('email').value=''; document.getElementById('senha2').value=''; setTimeout(() => {window.location.replace("index.html")},2500)};
}
